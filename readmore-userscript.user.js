...
document.getElementById('openUserscriptOptions').addEventListener('click', function(){$('#userscriptOptions').toggle();}, false);
document.getElementById('closeUserscriptOptions').addEventListener('click', function(){$('#userscriptOptions').toggle();}, false);

// Auf- und Einklappen von Unterkategorien
document.getElementById('toggle_sub_middleColumn_forum_reloadPosts_readNewPosts').addEventListener('click', function(){$('.sub_middleColumn_forum_reloadPosts_readNewPosts').toggle();}, false);
document.getElementById('toggle_sub_middleColumn_forum_reloadPosts_markNewPosts').addEventListener('click', function(){$('.sub_middleColumn_forum_reloadPosts_markNewPosts').toggle();}, false);
document.getElementById('toggle_sub_rightColumn_headlines_hideHeadlines').addEventListener('click', function(){$('.sub_rightColumn_headlines_hideHeadlines').toggle();}, false);
document.getElementById('toggle_sub_rightColumn_forum_hideForum').addEventListener('click', function(){$('.sub_rightColumn_forum_hideForum').toggle();}, false);
