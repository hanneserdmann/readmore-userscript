...
if (content.forum_thread){
	...
	if (options.options.miscellaneous_lastPageJumpToLastPost == 'checked') miscellaneous.lastPageJumpToLastPost();
	...
	if (options.options.middleColumn_forum_preview == 'checked'){
		...
		$('#triggerPreview').click(middleColumn.forum.preview.triggerPreview);
	}
	...
	if (options.options.middleColumn_forum_reloadPosts_readNewPosts == 'checked'){
		...
		if (options.options.middleColumn_forum_reloadPosts_markNewPosts == 'checked'){
			...
			// Favicon verändern
			if (options.options.middleColumn_forum_reloadPosts_changeFavicon == 'checked') setInterval(function(){middleColumn.forum.reloadPosts.changeFavicon()}, 1000);
			
			// Postanzahl im Tab anzeigen
			if (options.options.middleColumn_forum_reloadPosts_showNewPostsTitle == 'checked') setInterval(function(){middleColumn.forum.reloadPosts.showNewPostsTitle()}, 1000);
		}
...
$('body').append('<style type="text/css">#userscriptOptions.menuwrapper{display:none;position:absolute;height:700px;width:600px;left:50%;margin-left:-300px;top:75px;border:2px solid #00aeed;border-radius:0;border-top-left-radius:20px;border-bottom-left-radius:20px;background-color:#fff;overflow-x:hidden;overflow-y:scroll}#userscriptOptions h1{color:#000;font-size:30px;font-variant:small-caps;padding-left:20px;padding-top:20px;border:0}#userscriptOptions .version{float:right;padding-right:20px}#userscriptOptions>div{padding-left:20px;padding-right:20px;padding-top:20px}#userscriptOptions table{border:0;width:100%}#userscriptOptions .menuparent{background-color:#fff;margin:1000;padding:0}#userscriptOptions .menufirstchild{display:none;background-color:#eee;margin:0;padding:0}#userscriptOptions .menusecondchild{display:none;background-color:#ddd;margin:0;padding:0}#userscriptOptions input[type=checkbox],#userscriptOptions input[type=select],#userscriptOptions input[type=text]{margin:0;padding:0}#userscriptOptions .headline td{color:#fff;font-size:24px;font-variant:small-caps;margin:0;padding:5px;background-color:#00aeed;width:100%}</style>\n<div id="userscriptOptions" class="menuwrapper">\n<h1>Userscript Optionen</h1>\n<span class="version"><a href="index.php?cont=forum/thread&threadid=111239&pagenum=1">Thread</a> | Version 2.0.4</span>\n<div>\n<table>\n<tr>\n<td style="width:30px"></td>\n<td></td>\n<td style="width:180px"></td>\n<td style="width:25px"></td>\n</tr>\n<tr class="headline">\n<td colspan="4">\nFunktionen\n</td>\n</tr>\n<tr class="menuparent">\n<td align="left">\n<img id="toggle_sub_middleColumn_forum_reloadPosts_readNewPosts" src="http://thextor.de/readmore-userscript/img/plus_alt_16x16.png" alt="more" title="Weitere Optionen"/>\n</td>\n<td align="left">\nNeue Forenbeitr&auml;ge im Hintergrund nachladen\n</td>\n<td align="right">\n<input type="checkbox" class="userscriptOptions" name="middleColumn_forum_reloadPosts_readNewPosts"/>\n</td>\n<td align="right">\n<img src="http://thextor.de/readmore-userscript/img/magnifying_glass_16x16.png" alt="info" title="Neue Beitr&auml;ge im Readmore.de-Froum werden automatisch nachgeladen. Ein Refresh des Threads entf&auml;llt somit."/>\n</td>\n</tr>\n<tr class="menufirstchild sub_middleColumn_forum_reloadPosts_readNewPosts">\n<td align="left">\n</td>\n<td align="left">\nZeit zwischen zwei Reloads (in Sekunden)\n</td>\n<td align="right">\n<input type="text" class="userscriptOptions" name="middleColumn_forum_reloadPosts_waitUntilReload"/>\n</td>\n<td align="right">\n<img src="http://thextor.de/readmore-userscript/img/magnifying_glass_16x16.png" alt="info" title="Bitte Ganzzahlen eintragen. Werte ab 5 Sekunden werden empfohlen, bei einem k&uuml;rzeren Zeitraum kann es unter gewissen Umst&auml;nden zu (tempor&auml;ren) IP-Bans kommen."/>\n</td>\n</tr>\n<tr class="menufirstchild sub_middleColumn_forum_reloadPosts_readNewPosts">\n<td align="left">\n</td>\n<td align="left">\nSeite endlos erweitern\n</td>\n<td align="right">\n<input type="checkbox" class="userscriptOptions" name="middleColumn_forum_reloadPosts_endlessPage"/>\n</td>\n<td align="right">\n<img src="http://thextor.de/readmore-userscript/img/magnifying_glass_16x16.png" alt="info" title="Neue Posts werden einfach eingeblendet. Es muss also nicht mehr auf eine neue Seite gewechselt werden."/>\n</td>\n</tr>\n<tr class="menufirstchild sub_middleColumn_forum_reloadPosts_readNewPosts">\n<td align="left">\n<img id="toggle_sub_middleColumn_forum_reloadPosts_markNewPosts" src="http://thextor.de/readmore-userscript/img/plus_alt_16x16.png" alt="more" title="Weitere Optionen"/>\n</td>\n<td align="left">\nNeue Eintr&auml;ge farblich markieren\n</td>\n<td align="right">\n<input type="checkbox" class="userscriptOptions" name="middleColumn_forum_reloadPosts_markNewPosts"/>\n</td>\n<td align="right">\n<img src="http://thextor.de/readmore-userscript/img/magnifying_glass_16x16.png" alt="info" title="Die neu eingetragenen Posts werden markiert."/>\n</td>\n</tr>\n<tr class="menusecondchild sub_middleColumn_forum_reloadPosts_markNewPosts">\n<td align="left">\n</td>\n<td align="left">\nFarbe ausw&auml;hlen (HEX-Code)\n</td>\n<td align="right">\n<input type="text" class="userscriptOptions" name="middleColumn_forum_reloadPosts_markPostColor"/>\n</td>\n<td align="right">\n<img src="http://thextor.de/readmore-userscript/img/magnifying_glass_16x16.png" maxlength="7" alt="info" title="Bitte eine HEX Zahl eingeben. Beispiel: #FFEE11"/>\n</td>\n</tr>\n<tr class="menusecondchild sub_middleColumn_forum_reloadPosts_markNewPosts">\n<td align="left">\n</td>\n<td align="left">\nUngelesene Posts im Titel / Tab anzeigen\n</td>\n<td align="right">\n<input type="checkbox" class="userscriptOptions" name="middleColumn_forum_reloadPosts_showNewPostsTitle"/>\n</td>\n<td align="right">\n<img src="http://thextor.de/readmore-userscript/img/magnifying_glass_16x16.png" maxlength="7" alt="info" title="Die Anzahl der Ungelesenen Posts im Tab anzeigen."/>\n</td>\n</tr>\n<tr class="menusecondchild sub_middleColumn_forum_reloadPosts_markNewPosts">\n<td align="left">\n</td>\n<td align="left">\nFavicon ver&auml;ndern (nur Google Chrome)\n</td>\n<td align="right">\n<input type="checkbox" class="userscriptOptions" name="middleColumn_forum_reloadPosts_changeFavicon"/>\n</td>\n<td align="right">\n<img src="http://thextor.de/readmore-userscript/img/magnifying_glass_16x16.png" maxlength="7" alt="info" title="Die Anzahl der Ungelesenen Posts im Tab anzeigen."/>\n</td>\n</tr>\n<tr class="menuparent">\n<td align="left">\n</td>\n<td align="left">\nVorschaufunktion aktivieren\n</td>\n<td align="right">\n<input type="checkbox" class="userscriptOptions" name="middleColumn_forum_preview"/>\n</td>\n<td align="right">\n<img src="http://thextor.de/readmore-userscript/img/magnifying_glass_16x16.png" alt="info" title="Vorschau f&uuml;r neue Beitr&auml;ge einbinden."/>\n</td>\n</tr>\n<tr class="menuparent">\n<td align="left">\n</td>\n<td align="left">\nBeitr&auml;ge ohne Reload senden\n</td>\n<td align="right">\n<input type="checkbox" class="userscriptOptions" name="middleColumn_forum_postPerAjax"/>\n</td>\n<td align="right">\n<img src="http://thextor.de/readmore-userscript/img/magnifying_glass_16x16.png" alt="info" title="Beitr&auml;ge werden im Hintergrund gepostet. Ein manueller Refresh der Seite entfällt."/>\n</td>\n</tr>\n<tr>\n<td colspan="4">\n&nbsp;\n</td>\n</tr>\n<tr class="headline">\n<td colspan="4">\nOptische Ver&auml;nderungen\n</td>\n</tr>\n<tr class="menuparent">\n<td align="left">\n</td>\n<td align="left">\nTicker ausblenden\n</td>\n<td align="right">\n<input type="checkbox" class="userscriptOptions" name="rightColumn_ticker_hideTicker"/>\n</td>\n<td align="right">\n<img src="http://thextor.de/readmore-userscript/img/magnifying_glass_16x16.png" alt="info" title="Der Ticker wird komplett ausgeblendet."/>\n</td>\n</tr>\n<tr class="menuparent">\n<td align="left">\n<img id="toggle_sub_rightColumn_headlines_hideHeadlines" src="http://thextor.de/readmore-userscript/img/plus_alt_16x16.png" alt="more" title="Weitere Optionen"/>\n</td>\n<td align="left">\nSchlagzeilen ausblenden\n</td>\n<td align="right">\n</td>\n<td align="right">\n<img src="http://thextor.de/readmore-userscript/img/magnifying_glass_16x16.png" alt="info" title="Bestimmte oder alle Schlagzeilen ausblenden"/>\n</td>\n</tr>\n<tr class="menufirstchild sub_rightColumn_headlines_hideHeadlines">\n<td align="left">\n</td>\n<td align="left">\nAlle ausblenden\n</td>\n<td align="right">\n<input type="checkbox" class="userscriptOptions" name="rightColumn_headlines_hideHeadlines"/>\n</td>\n<td align="right">\n<img src="http://thextor.de/readmore-userscript/img/magnifying_glass_16x16.png" alt="info" title="Blendet alle Schlagzeilen aus."/>\n</td>\n</tr>\n<tr class="menufirstchild sub_rightColumn_headlines_hideHeadlines">\n<td align="left">\n</td>\n<td align="left">\nCounter-Strike ausblenden\n</td>\n<td align="right">\n<input type="checkbox" class="userscriptOptions" name="rightColumn_headlines_hideCounterstrike"/>\n</td>\n<td align="right">\n<img src="http://thextor.de/readmore-userscript/img/magnifying_glass_16x16.png" alt="info" title="Blendet die Counter-Strike Schlagzeilen aus."/>\n</td>\n</tr>\n<tr class="menufirstchild sub_rightColumn_headlines_hideHeadlines">\n<td align="left">\n</td>\n<td align="left">\nStarcraft ausblenden\n</td>\n<td align="right">\n<input type="checkbox" class="userscriptOptions" name="rightColumn_headlines_hideStarcraft"/>\n</td>\n<td align="right">\n<img src="http://thextor.de/readmore-userscript/img/magnifying_glass_16x16.png" alt="info" title="Blendet die Starcraft Schlagzeilen aus."/>\n</td>\n</tr>\n<tr class="menufirstchild sub_rightColumn_headlines_hideHeadlines">\n<td align="left">\n</td>\n<td align="left">\nDotA ausblenden\n</td>\n<td align="right">\n<input type="checkbox" class="userscriptOptions" name="rightColumn_headlines_hideDefenseOfTheAncients"/>\n</td>\n<td align="right">\n<img src="http://thextor.de/readmore-userscript/img/magnifying_glass_16x16.png" alt="info" title="Blendet die DotA Schlagzeilen aus."/>\n</td>\n</tr>\n<tr class="menufirstchild sub_rightColumn_headlines_hideHeadlines">\n<td align="left">\n</td>\n<td align="left">\nLeague of Legends ausblenden\n</td>\n<td align="right">\n<input type="checkbox" class="userscriptOptions" name="rightColumn_headlines_hideLeagueOfLegends"/>\n</td>\n<td align="right">\n<img src="http://thextor.de/readmore-userscript/img/magnifying_glass_16x16.png" alt="info" title="Blendet die League of Legends Schlagzeilen aus."/>\n</td>\n</tr>\n<tr class="menufirstchild sub_rightColumn_headlines_hideHeadlines">\n<td align="left">\n</td>\n<td align="left">\nWarcraft 3 ausblenden\n</td>\n<td align="right">\n<input type="checkbox" class="userscriptOptions" name="rightColumn_headlines_hideWarcraft3"/>\n</td>\n<td align="right">\n<img src="http://thextor.de/readmore-userscript/img/magnifying_glass_16x16.png" alt="info" title="Blendet die Warcraft 3 Schlagzeilen aus."/>\n</td>\n</tr>\n<tr class="menufirstchild sub_rightColumn_headlines_hideHeadlines">\n<td align="left">\n</td>\n<td align="left">\nSonstiges ausblenden\n</td>\n<td align="right">\n<input type="checkbox" class="userscriptOptions" name="rightColumn_headlines_hideSonstiges"/>\n</td>\n<td align="right">\n<img src="http://thextor.de/readmore-userscript/img/magnifying_glass_16x16.png" alt="info" title="Blendet die Sonstigen Schlagzeilen aus."/>\n</td>\n</tr>\n<tr class="menuparent">\n<td align="left">\n<img id="toggle_sub_rightColumn_forum_hideForum" src="http://thextor.de/readmore-userscript/img/plus_alt_16x16.png" alt="more" title="Weitere Optionen"/>\n</td>\n<td align="left">\nForum ausblenden und umsortieren\n</td>\n<td align="right">\n</td>\n<td align="right">\n<img src="http://thextor.de/readmore-userscript/img/magnifying_glass_16x16.png" alt="info" title="Das Forum ausblenden oder umsortieren."/>\n</td>\n</tr>\n<tr class="menufirstchild sub_rightColumn_forum_hideForum">\n<td align="left">\n</td>\n<td align="left">\nKomplett ausblenden\n</td>\n<td align="right">\n<input type="checkbox" class="userscriptOptions" name="rightColumn_forum_hideForum"/>\n</td>\n<td align="right">\n<img src="http://thextor.de/readmore-userscript/img/magnifying_glass_16x16.png" alt="info" title="Das komplette Forum ausblenden."/>\n</td>\n</tr>\n<tr class="menufirstchild sub_rightColumn_forum_hideForum">\n<td align="left">\n<img id="toggle_sub_rightColumn_forum_sections" src="http://thextor.de/readmore-userscript/img/plus_alt_16x16.png" alt="more" title="Weitere Optionen"/>\n</td>\n<td align="left">\nForen umsortieren\n</td>\n<td align="right">\n<input type="checkbox" class="userscriptOptions" name="rightColumn_forum_sections"/>\n</td>\n<td align="right">\n<img src="http://thextor.de/readmore-userscript/img/magnifying_glass_16x16.png" alt="info" title="Ermöglicht das Umsortieren des Forums."/>\n</td>\n</tr>\n<tr class="menusecondchild sub_rightColumn_forum_sections">\n<td align="left">\n</td>\n<td align="left">\nAn erster Stelle\n</td>\n<td align="right">\n<select size="1" class="userscriptOptions" name="rightColumn_forum_hideForum_0">\n<option value="">Nichts anzeigen</option>\n<option value="featuredthreads">Featured Threads</option>\n<option value="esportforen">eSport Foren</option>\n<option value="technik">Technik</option>\n<option value="offtopicforen">Offtopic Foren</option>\n<option value="spiele">Spiele</option>\n<option value="diablo">Diablo 3</option>\n</select>\n</td>\n<td align="right">\n<img src="http://thextor.de/readmore-userscript/img/magnifying_glass_16x16.png" alt="info" title="Erste Stelle bei der Anzeige der Foren."/>\n</td>\n</tr>\n<tr class="menusecondchild sub_rightColumn_forum_sections">\n<td align="left">\n</td>\n<td align="left">\nAn zweiter Stelle\n</td>\n<td align="right">\n<select size="1" class="userscriptOptions" name="rightColumn_forum_hideForum_1">\n<option value="">Nichts anzeigen</option>\n<option value="featuredthreads">Featured Threads</option>\n<option value="esportforen">eSport Foren</option>\n<option value="technik">Technik</option>\n<option value="offtopicforen">Offtopic Foren</option>\n<option value="spiele">Spiele</option>\n<option value="diablo">Diablo 3</option>\n</select>\n</td>\n<td align="right">\n<img src="http://thextor.de/readmore-userscript/img/magnifying_glass_16x16.png" alt="info" title="Zweite Stelle bei der Anzeige der Foren."/>\n</td>\n</tr>\n<tr class="menusecondchild sub_rightColumn_forum_sections">\n<td align="left">\n</td>\n<td align="left">\nAn dritter Stelle\n</td>\n<td align="right">\n<select size="1" class="userscriptOptions" name="rightColumn_forum_hideForum_2">\n<option value="">Nichts anzeigen</option>\n<option value="featuredthreads">Featured Threads</option>\n<option value="esportforen">eSport Foren</option>\n<option value="technik">Technik</option>\n<option value="offtopicforen">Offtopic Foren</option>\n<option value="spiele">Spiele</option>\n<option value="diablo">Diablo 3</option>\n</select>\n</td>\n<td align="right">\n<img src="http://thextor.de/readmore-userscript/img/magnifying_glass_16x16.png" alt="info" title="Dritte Stelle bei der Anzeige der Foren."/>\n</td>\n</tr>\n<tr class="menusecondchild sub_rightColumn_forum_sections">\n<td align="left">\n</td>\n<td align="left">\nAn vierter Stelle\n</td>\n<td align="right">\n<select size="1" class="userscriptOptions" name="rightColumn_forum_hideForum_3">\n<option value="">Nichts anzeigen</option>\n<option value="featuredthreads">Featured Threads</option>\n<option value="esportforen">eSport Foren</option>\n<option value="technik">Technik</option>\n<option value="offtopicforen">Offtopic Foren</option>\n<option value="spiele">Spiele</option>\n<option value="diablo">Diablo 3</option>\n</select>\n</td>\n<td align="right">\n<img src="http://thextor.de/readmore-userscript/img/magnifying_glass_16x16.png" alt="info" title="Viere Stelle bei der Anzeige der Foren."/>\n</td>\n</tr>\n<tr class="menusecondchild sub_rightColumn_forum_sections">\n<td align="left">\n</td>\n<td align="left">\nAn f&uuml;nfter Stelle\n</td>\n<td align="right">\n<select size="1" class="userscriptOptions" name="rightColumn_forum_hideForum_4">\n<option value="">Nichts anzeigen</option>\n<option value="featuredthreads">Featured Threads</option>\n<option value="esportforen">eSport Foren</option>\n<option value="technik">Technik</option>\n<option value="offtopicforen">Offtopic Foren</option>\n<option value="spiele">Spiele</option>\n<option value="diablo">Diablo 3</option>\n</select>\n</td>\n<td align="right">\n<img src="http://thextor.de/readmore-userscript/img/magnifying_glass_16x16.png" alt="info" title="F&uuml;nfte Stelle bei der Anzeige der Foren."/>\n</td>\n</tr>\n<tr class="menusecondchild sub_rightColumn_forum_sections">\n<td align="left">\n</td>\n<td align="left">\nAn sechster Stelle\n</td>\n<td align="right">\n<select size="1" class="userscriptOptions" name="rightColumn_forum_hideForum_5">\n<option value="">Nichts anzeigen</option>\n<option value="featuredthreads">Featured Threads</option>\n<option value="esportforen">eSport Foren</option>\n<option value="technik">Technik</option>\n<option value="offtopicforen">Offtopic Foren</option>\n<option value="spiele">Spiele</option>\n<option value="diablo">Diablo 3</option>\n</select>\n</td>\n<td align="right">\n<img src="http://thextor.de/readmore-userscript/img/magnifying_glass_16x16.png" alt="info" title="Sechste Stelle bei der Anzeige der Foren."/>\n</td>\n</tr>\n<tr class="menuparent">\n<td align="left">\n</td>\n<td align="left">\nWer? Wohin? Warum? ausblenden\n</td>\n<td align="right">\n<input type="checkbox" class="userscriptOptions" name="leftColumn_www_hideWww"/>\n</td>\n<td align="right">\n<img src="http://thextor.de/readmore-userscript/img/magnifying_glass_16x16.png" alt="info" title="Blendet die komplette Wer? Wohin? Warum? Sektion aus."/>\n</td>\n</tr>\n<tr class="menuparent">\n<td align="left">\n<img id="toggle_sub_leftColumn_streams_hideStreams" src="http://thextor.de/readmore-userscript/img/plus_alt_16x16.png" alt="more" title="Weitere Optionen"/>\n</td>\n<td align="left">\nStreams ausblenden\n</td>\n<td align="right">\n</td>\n<td align="right">\n<img src="http://thextor.de/readmore-userscript/img/magnifying_glass_16x16.png" alt="info" title="Bestimmte oder alle Streams ausblenden"/>\n</td>\n</tr>\n<tr class="menufirstchild sub_leftColumn_streams_hideStreams">\n<td align="left">\n</td>\n<td align="left">\nAlle Streams ausblenden\n</td>\n<td align="right">\n<input type="checkbox" class="userscriptOptions" name="leftColumn_streams_hideStreams"/>\n</td>\n<td align="right">\n<img src="http://thextor.de/readmore-userscript/img/magnifying_glass_16x16.png" alt="info" title="Blendet alle Userstreams und Caster aus."/>\n</td>\n</tr>\n<tr class="menufirstchild sub_leftColumn_streams_hideStreams">\n<td align="left">\n</td>\n<td align="left">\nBattlefield 3\n</td>\n<td align="right">\n<input type="checkbox" class="userscriptOptions" name="leftColumn_streams_hideSelectedStreams_bf3"/>\n</td>\n<td align="right">\n<img src="http://thextor.de/readmore-userscript/img/magnifying_glass_16x16.png" alt="info" title="Blendet Battlefield 3 aus."/>\n</td>\n</tr>\n<tr class="menufirstchild sub_leftColumn_streams_hideStreams">\n<td align="left">\n</td>\n<td align="left">\nCounterstrike 1.6\n</td>\n<td align="right">\n<input type="checkbox" class="userscriptOptions" name="leftColumn_streams_hideSelectedStreams_cs"/>\n</td>\n<td align="right">\n<img src="http://thextor.de/readmore-userscript/img/magnifying_glass_16x16.png" alt="info" title="Blendet Counterstrike 1.6 aus."/>\n</td>\n</tr>\n<tr class="menufirstchild sub_leftColumn_streams_hideStreams">\n<td align="left">\n</td>\n<td align="left">\nCounterstrike Global Offensive\n</td>\n<td align="right">\n<input type="checkbox" class="userscriptOptions" name="leftColumn_streams_hideSelectedStreams_csgo"/>\n</td>\n<td align="right">\n<img src="http://thextor.de/readmore-userscript/img/magnifying_glass_16x16.png" alt="info" title="Blendet Counterstrike Global Offensive aus."/>\n</td>\n</tr>\n<tr class="menufirstchild sub_leftColumn_streams_hideStreams">\n<td align="left">\n</td>\n<td align="left">\nCounterstrike Source\n</td>\n<td align="right">\n<input type="checkbox" class="userscriptOptions" name="leftColumn_streams_hideSelectedStreams_css"/>\n</td>\n<td align="right">\n<img src="http://thextor.de/readmore-userscript/img/magnifying_glass_16x16.png" alt="info" title="Blendet Counterstrike Source aus."/>\n</td>\n</tr>\n<tr class="menufirstchild sub_leftColumn_streams_hideStreams">\n<td align="left">\n</td>\n<td align="left">\nDefense of the Ancients\n</td>\n<td align="right">\n<input type="checkbox" class="userscriptOptions" name="leftColumn_streams_hideSelectedStreams_dota"/>\n</td>\n<td align="right">\n<img src="http://thextor.de/readmore-userscript/img/magnifying_glass_16x16.png" alt="info" title="Blendet Defense of the Ancients aus."/>\n</td>\n</tr>\n<tr class="menufirstchild sub_leftColumn_streams_hideStreams">\n<td align="left">\n</td>\n<td align="left">\nDefense of the Ancients 2\n</td>\n<td align="right">\n<input type="checkbox" class="userscriptOptions" name="leftColumn_streams_hideSelectedStreams_dota2"/>\n</td>\n<td align="right">\n<img src="http://thextor.de/readmore-userscript/img/magnifying_glass_16x16.png" alt="info" title="Blendet Defense of the Ancients 2 aus."/>\n</td>\n</tr>\n<tr class="menufirstchild sub_leftColumn_streams_hideStreams">\n<td align="left">\n</td>\n<td align="left">\nDiablo 3\n</td>\n<td align="right">\n<input type="checkbox" class="userscriptOptions" name="leftColumn_streams_hideSelectedStreams_d3"/>\n</td>\n<td align="right">\n<img src="http://thextor.de/readmore-userscript/img/magnifying_glass_16x16.png" alt="info" title="Blendet Diablo 3 aus."/>\n</td>\n</tr>\n<tr class="menufirstchild sub_leftColumn_streams_hideStreams">\n<td align="left">\n</td>\n<td align="left">\nFußball\n</td>\n<td align="right">\n<input type="checkbox" class="userscriptOptions" name="leftColumn_streams_hideSelectedStreams_soccer"/>\n</td>\n<td align="right">\n<img src="http://thextor.de/readmore-userscript/img/magnifying_glass_16x16.png" alt="info" title="Blendet Fußball aus."/>\n</td>\n</tr>\n<tr class="menufirstchild sub_leftColumn_streams_hideStreams">\n<td align="left">\n</td>\n<td align="left">\nHeroes of Newerth\n</td>\n<td align="right">\n<input type="checkbox" class="userscriptOptions" name="leftColumn_streams_hideSelectedStreams_hon"/>\n</td>\n<td align="right">\n<img src="http://thextor.de/readmore-userscript/img/magnifying_glass_16x16.png" alt="info" title="Blendet Heroes of Newerth aus."/>\n</td>\n</tr>\n<tr class="menufirstchild sub_leftColumn_streams_hideStreams">\n<td align="left">\n</td>\n<td align="left">\nLeage of Legends\n</td>\n<td align="right">\n<input type="checkbox" class="userscriptOptions" name="leftColumn_streams_hideSelectedStreams_lol"/>\n</td>\n<td align="right">\n<img src="http://thextor.de/readmore-userscript/img/magnifying_glass_16x16.png" alt="info" title="Blendet Leage of Legends aus."/>\n</td>\n</tr>\n<tr class="menufirstchild sub_leftColumn_streams_hideStreams">\n<td align="left">\n</td>\n<td align="left">\nQuake\n</td>\n<td align="right">\n<input type="checkbox" class="userscriptOptions" name="leftColumn_streams_hideSelectedStreams_ql"/>\n</td>\n<td align="right">\n<img src="http://thextor.de/readmore-userscript/img/magnifying_glass_16x16.png" alt="info" title="Blendet Quake aus."/>\n</td>\n</tr>\n<tr class="menufirstchild sub_leftColumn_streams_hideStreams">\n<td align="left">\n</td>\n<td align="left">\nStarcraft\n</td>\n<td align="right">\n<input type="checkbox" class="userscriptOptions" name="leftColumn_streams_hideSelectedStreams_sc"/>\n</td>\n<td align="right">\n<img src="http://thextor.de/readmore-userscript/img/magnifying_glass_16x16.png" alt="info" title="Blendet Starcraft aus."/>\n</td>\n</tr>\n<tr class="menufirstchild sub_leftColumn_streams_hideStreams">\n<td align="left">\n</td>\n<td align="left">\nStarcraft 2\n</td>\n<td align="right">\n<input type="checkbox" class="userscriptOptions" name="leftColumn_streams_hideSelectedStreams_sc2"/>\n</td>\n<td align="right">\n<img src="http://thextor.de/readmore-userscript/img/magnifying_glass_16x16.png" alt="info" title="Blendet Starcraft 2 aus."/>\n</td>\n</tr>\n<tr class="menufirstchild sub_leftColumn_streams_hideStreams">\n<td align="left">\n</td>\n<td align="left">\nWarcraft 3\n</td>\n<td align="right">\n<input type="checkbox" class="userscriptOptions" name="leftColumn_streams_hideSelectedStreams_wc3"/>\n</td>\n<td align="right">\n<img src="http://thextor.de/readmore-userscript/img/magnifying_glass_16x16.png" alt="info" title="Blendet Quake aus."/>\n</td>\n</tr>\n<tr class="menufirstchild sub_leftColumn_streams_hideStreams">\n<td align="left">\n</td>\n<td align="left">\nSonstiges\n</td>\n<td align="right">\n<input type="checkbox" class="userscriptOptions" name="leftColumn_streams_hideSelectedStreams_else"/>\n</td>\n<td align="right">\n<img src="http://thextor.de/readmore-userscript/img/magnifying_glass_16x16.png" alt="info" title="Blendet den Rest aus."/>\n</td>\n</tr>\n<tr>\n<td colspan="4">\n&nbsp;\n</td>\n</tr>\n<tr class="headline">\n<td colspan="4">\nSonstiges\n</td>\n</tr>\n<tr class="menuparent">\n<td align="left">\n</td>\n<td align="left">\nButton zum Runterscrollen anzeigen\n</td>\n<td align="right">\n<input type="checkbox" class="userscriptOptions" name="miscellaneous_buttonScrollDown"/>\n</td>\n<td align="right">\n<img src="http://thextor.de/readmore-userscript/img/magnifying_glass_16x16.png" alt="info" title="Im Forum wird ein Icon eingefügt, beim betätigen wird zum letzten Post gesprungen."/>\n</td>\n</tr>\n<tr class="menuparent">\n<td align="left">\n</td>\n<td align="left">\nButton zum Hochscrollen anzeigen\n</td>\n<td align="right">\n<input type="checkbox" class="userscriptOptions" name="miscellaneous_buttonScrollUp"/>\n</td>\n<td align="right">\n<img src="http://thextor.de/readmore-userscript/img/magnifying_glass_16x16.png" alt="info" title="Im Forum wird ein Icon eingefügt, beim betätigen wird zum ersten Post gesprungen."/>\n</td>\n</tr>\n<tr class="menuparent">\n<td align="left">\n</td>\n<td align="left">\nTitel/Tab umsortieren\n</td>\n<td align="right">\n<input type="checkbox" class="userscriptOptions" name="miscellaneous_reSortTitle"/>\n</td>\n<td align="right">\n<img src="http://thextor.de/readmore-userscript/img/magnifying_glass_16x16.png" alt="info" title="Wenn diese Option aktiviert ist, wird der Threadname an den Anfang des Titels gestellt. Offene Tabs können so besser den verschiedenen Threads zugeordnet werden."/>\n</td>\n</tr>\n<tr class="menuparent">\n<td align="left">\n</td>\n<td align="left">\nAuf Update pr&uuml;fen\n</td>\n<td align="right">\n<input type="checkbox" class="userscriptOptions" name="miscellaneous_checkVersion"/>\n</td>\n<td align="right">\n<img src="http://thextor.de/readmore-userscript/img/magnifying_glass_16x16.png" alt="info" title="Sollte eine neue Version erscheinen, wird der Benutzer darüber informiert. Ein Hinweis erscheint oben in der Userbar."/>\n</td>\n</tr>\n<tr class="menuparent">\n<td align="left">\n</td>\n<td align="left">\nLast-Page-Pfeil springt zum letzten Post\n</td>\n<td align="right">\n<input type="checkbox" class="userscriptOptions" name="miscellaneous_lastPageJumpToLastPost"/>\n</td>\n<td align="right">\n<img src="http://thextor.de/readmore-userscript/img/magnifying_glass_16x16.png" alt="info" title="Nach dem Bet&auml;tigen des Pfeils (ganz Recht im Forum, hinter den Threads) wird zum aktuellsten Post gesprungen."/>\n</td>\n</tr>\n<tr>\n<td align="right" colspan="4">\n<br/><input style="padding:10px" type="button" id="closeUserscriptOptions" value="Abbrechen / Schlie&szlig;en"/> &nbsp;&nbsp; <input style="padding:10px" type="button" value="Speichern" id="saveUserscriptOptions"/>\n</td>\n</tr>\n</table>\n</div>\n</div>');
$('#saveUserscriptOptions').click(function(){options.saveOptions()});
$('#openUserscriptOptions').click(function(){options.loadOptions()});
$('#openUserscriptOptions').click(function(){$('#userscriptOptions').toggle()});
$('#closeUserscriptOptions').click(function(){$('#userscriptOptions').toggle()});

// Auf- und Einklappen von Unterkategorien
$('#toggle_sub_middleColumn_forum_reloadPosts_readNewPosts').click(function(){$('.sub_middleColumn_forum_reloadPosts_readNewPosts').toggle()});
$('#toggle_sub_middleColumn_forum_reloadPosts_markNewPosts').click(function(){$('.sub_middleColumn_forum_reloadPosts_markNewPosts').toggle()});
$('#toggle_sub_rightColumn_headlines_hideHeadlines').click(function(){$('.sub_rightColumn_headlines_hideHeadlines').toggle()});
$('#toggle_sub_rightColumn_forum_hideForum').click(function(){$('.sub_rightColumn_forum_hideForum').toggle()});
$('#toggle_sub_rightColumn_forum_sections').click(function(){$('.sub_rightColumn_forum_sections').toggle()});
$('#toggle_sub_leftColumn_streams_hideStreams').click(function(){$('.sub_leftColumn_streams_hideStreams').toggle()});
