...
miscellaneous = {
	...
	// Extrabuttons von IllDepence einbinden
	extraButtons : function(){
		$('head').append('<script type="text/javascript" src="http://tareksaier.bplaced.net/notHP/rmeb/rmeb.js"></script>');
	}
};
