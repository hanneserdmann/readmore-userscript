...
if (options.options.rightColumn_headlines_hideHeadlines == 'checked')	rightColumn.headlines.hideHeadlines();
else{
...
if (section == 'forum'){
	if (options.options.middleColumn_forum_reloadPosts_readNewPosts == 'checked'){
		...
		if (options.options.middleColumn_forum_reloadPosts_endlessPage == 'checked'){
			...
			if (lastpage.substr(lastpage.length-4) == '</b>') window.setInterval(function(){middleColumn.forum.reloadPosts.endlessPage();}, 5000);			
		} 
