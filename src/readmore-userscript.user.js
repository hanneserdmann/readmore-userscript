		...
		messages: {
			...
			displayToUser: function (msgsReceived, currentLinkNode) {
				...
				switch (RMUS.browser.getBrowser()) {
					...
					case 'opera':
					case 'msie':
						if (RMUS.options.options.miscellaneous_reloadMessages_alertBox) {
							if (msgsReceived === 1) {
