...
if (!content.profile && !content.guides) {
	...
	if (RMUS.options.options.rightColumn_forum_reloadForum == 'checked' || RMUS.options.options.leftColumn_streams_reloadStreams == 'checked' || RMUS.options.options.leftColumn_streams_showReadmoreUserStreams == 'checked' || RMUS.options.options.rightColumn_ticker_reloadTicker == 'checked'){
		RMUS.miscellaneous.reloadMainpageData.readPage();
	}
