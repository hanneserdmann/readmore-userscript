...
var RMUS = {
	...
	miscellaneous: {
		...
		extrabuttons: {
			...
			toolbarButtonTexts: [["http://thextor.de/readmore-userscript/img/extrabuttons/I16Hg.png", "\x28\u256f\xb0\u25a1\xb0\uff09\u256f\ufe35\x20\u253b\u2501\u253b", "tableflip"],
								["http://thextor.de/readmore-userscript/img/extrabuttons/M92Ll.png", "[youtube]3WzB63CUOtc[/youtube]", "aha bye"],
								["http://thextor.de/readmore-userscript/img/extrabuttons/oOZFn.png", "[image]http://thextor.de/readmore-userscript/img/extrabuttons/ERRRn.jpg[/image]", "mckay outfit"]],
				...
				loadStreams : function(){
					if (RMUS.miscellaneous.reloadMainpageData.mainpageData == ''){
						...
						for (var i = 0; i < icons.length; i++){
							var username = usernames[i].replace(/title=/g, '').replace(/@/g, '').replace(/"/g, '').replace(/own3d.tv/g, '').replace(/justin.tv/g, '').trim();
