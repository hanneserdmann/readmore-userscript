...
window.setInterval(function(){
	...
	if (content.forum_thread) {
		...
		if (RMUS.options.options.middleColumn_forum_scrollForNewPage == 'checked' && (RMUS.options.options.middleColumn_forum_reloadPosts_endlessPage != 'checked' || $.trim($('div.floatl.m2.elf').html()).substr($.trim($('div.floatl.m2.elf').html()).length-4) != '</b>')) {
